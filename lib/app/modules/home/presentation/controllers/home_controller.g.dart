...
mixin _$HomeController on _HomeControllerBase, Store {
  late final _$cardsAtom = Atom(
    name: '_HomeControllerBase.cards',
    context: context,
  );
  ...
  late final _$fetchUserCardsAsyncAction = AsyncAction(
    '_HomeControllerBase.fetchUserCards',
    context: context,
  );
  ...
  late final _$deleteCardAsyncAction = AsyncAction(
    '_HomeControllerBase.deleteCard',
    context: context,
  );
